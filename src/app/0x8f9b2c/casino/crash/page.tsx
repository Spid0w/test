    ...
    <main className="min-h-screen bg-[#050505] text-white selection:bg-[#d4af37] selection:text-black">
      ...
      <section className="relative z-10 pb-24 px-6">
        <div className="max-w-3xl mx-auto bg-zinc-900/30 rounded-2xl p-8 border border-white/5">
           <h2 className="text-lg font-black uppercase italic tracking-tighter mb-4 text-[#d4af37]">High Stakes Launch</h2>
           <p className="text-zinc-400 text-sm leading-relaxed mb-4">
             Watch the multiplier climb as the rocket ascends. The higher it goes, the more you win. 
             But there's a catch: the rocket can explode at any moment. 
             You must click "Cash Out" before the crash to secure your winnings. 
             Greed can be your best friend or your worst enemy in Rocket Crash.
           </p>
           <div className="flex gap-8 mt-8">
              ...
              <div>
                 <div className="text-[10px] font-bold text-zinc-600 uppercase mb-1">Speed</div>
                 <div className="text-sm font-black">Dynamic</div>
              </div>
           </div>
        </div>
      </section>
