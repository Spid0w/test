    ...
    <main className="min-h-screen bg-[#050505] text-white selection:bg-[#d4af37] selection:text-black">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <h1 className="text-2xl font-black tracking-tighter italic uppercase">
              Black <span className="text-[#d4af37]">Jack</span> <span className="text-zinc-600 text-sm normal-case not-italic ml-2 font-bold">EUROPEAN</span>
            </h1>
          </div>
      ...
      <section className="relative z-10 pb-24 px-6">
        <div className="max-w-3xl mx-auto bg-zinc-900/30 rounded-2xl p-8 border border-white/5">
           <h2 className="text-lg font-black uppercase italic tracking-tighter mb-4 text-[#d4af37]">The High Roller Table</h2>
           <p className="text-zinc-400 text-sm leading-relaxed mb-4">
             Experience the ultimate European Blackjack. No bonus side bets, no distractions. Just you against the dealer.
             Play up to 3 hands simultaneously, double down for maximum profit, and aim for that perfect 21.
             Our ultra-modern table offers the smoothest animations and a premium atmosphere for the most discerning players.
           </p>
           <div className="grid grid-cols-3 gap-8 mt-8">
              <div>
                 <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest leading-none">Min Bet</span>
                 <div className="text-sm font-black">$10.00</div>
              </div>
              <div>
                 <div className="text-[10px] font-bold text-zinc-600 uppercase mb-1">Max Hands</div>
                 <div className="text-sm font-black">3 Slots</div>
              </div>
              <div>
                 <div className="text-[10px] font-bold text-zinc-600 uppercase mb-1">Payout</div>
                 <div className="text-sm font-black">3:2 Blackjack</div>
              </div>
           </div>
        </div>
      </section>
